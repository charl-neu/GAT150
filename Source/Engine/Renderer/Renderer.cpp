...
namespace viper {
    ...
    void Renderer::SetColoru(uint8_t r, uint8_t g, uint8_t b, uint8_t a)
    {
    ...
    void Renderer::DrawTextureRotated(Texture& texture, float x, float y, float angle, float scale, bool fliph)
    {
        vec2 size = texture.GetSize();
